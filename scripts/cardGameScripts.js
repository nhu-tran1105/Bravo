...
import { saveScore, getHighScore, savePlayerStats, showSavedStats } from "./storage.js";
...
function disableCards() {
  ...
  // ✅ Save player stats to cookies (via storage.js)
...
function checkWin() {
  ...
  if (score === totalPairs) {
    ...
    // ✅ Save final stats to cookie once round is finished
    savePlayerStats(playerName, score);

    console.log("🏁 Round finished!");
    alert(`🎉 Great job, ${playerName}! You found all ${totalPairs} pairs!`);
